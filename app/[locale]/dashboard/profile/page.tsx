  ...
  if (!user) {
    return (
      <div className="text-center py-16">
        ...
        <Link href="/login">
          <Button className="mt-4">{tCommon('login')}</Button>
        </Link>
      </div>
    );
  }
      ...
      <Card>
        ...
        <CardContent>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-muted-foreground">
                          {tFolder('items', { count: folder.itemCount })}
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          {folders.length > 6 && (
            <Link href="/dashboard/my-folder">
              <Button variant="link" className="w-full mt-4">
                {t('viewAllCount', { count: folders.length })}
              </Button>
            </Link>
          )}
        </CardContent>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">{t('timesSearched')}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">{tFavorites('title')}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">{t('folders')}</p>
              </div>
            </div>
          </CardContent>
        </Card>
